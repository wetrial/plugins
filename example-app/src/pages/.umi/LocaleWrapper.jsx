...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/pages/user/login/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/pages/user/login/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Work/Project/umi-plugins-module/example-app/src/pages/user/login/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
